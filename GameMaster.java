...
public class GameMaster {
	...
	public static Player getPlayer(String name) {
		...
		else if(name.equalsIgnoreCase("RukiaKuchiki"))
			return new RukiaKuchiki();
		else if(name.equalsIgnoreCase("ShunsuiKyoraku"))
			return new ShunsuiKyoraku();
		else if(name.equalsIgnoreCase("BlackStar"))
			return new BlackStar();
		else if(name.equalsIgnoreCase("TsubakiNakatsukasa"))
			return new TsubakiNakatsukasa();
		////////////////////////////////////
		return null;
	}
	/**
	...
	public static void main(String[] args) {
		...
		////////////////////////////////////
		players.add(new RukiaKuchiki());
		players.add(new ShunsuiKyoraku());
		players.add(new BlackStar());
		players.add(new TsubakiNakatsukasa());
		////////////////////////////////////
